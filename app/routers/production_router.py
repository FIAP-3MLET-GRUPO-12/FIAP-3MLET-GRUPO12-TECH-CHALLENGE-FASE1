...
@router.get("/", response_model=ProductReportSchema, summary="Get product production report for last year")
...
@router.get("/{year}", response_model=ProductReportSchema, summary="Get product production report for a specific year")
